...
const emailProcessor = ({ email, pin, type, verificationLink = "http://localhost:4200/resetpassword" }) => {
  let info = "";
  switch (type) {
    case "request-new-password":
      info = {
        from: '"CMR Company" <vcrm.company.in@gmail.com>', // sender address
